...
export const DashboardView = ({ onViewChange }) => {
  ...
  if (role === "guard") {
    allLogs = [
      {
        time: "10:30 AM",
        action: "Visitor verified with OTP",
        type: "success",
        icon: UserCheckIcon,
      },
      {
              ...
              <Card key={index} className="metric-card group cursor-pointer">
                <CardContent className="p-3 sm:p-4 lg:p-6">
                  <div className="flex items-start justify-between mb-3 sm:mb-4">
                    <div
                      className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center shadow-soft group-hover:scale-110 transition-transform duration-200`}
                    >
        ...
        <Card className="glass-effect rounded-2xl shadow-soft border-0">
          ...
          <CardContent
            className={`space-y-3 sm:space-y-4${
              allLogs.length > 5 ? " max-h-60 sm:max-h-80 overflow-y-auto" : ""
            }`}
          >
              ...
              return (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-10 h-10 bg-gradient-to-br ${action.color} rounded-xl flex items-center justify-center shadow-soft group-hover:scale-110 transition-transform duration-200`}
                    >
