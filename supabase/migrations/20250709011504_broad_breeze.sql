/*
  # Final Migration: SaaS Features and Sample Data

  1. SaaS Features
    - Add subscription management to estates
    - Add subdomain support for multi-tenancy
    - Add usage tracking and limits
    - Add audit logging system

  2. Sample Data
    - Create sample estate with admin, guard, and resident
    - Add sample visitor invites (without logs to avoid trigger conflicts)
...
BEGIN
    ...
    IF sample_estate_id IS NOT NULL THEN
        ...
        (
          sample_estate_id,
          (SELECT user_id FROM estate_admins WHERE unique_id = 'ADM-SAMPLE-001' LIMIT 1),
          'visitor_arrival',
          'New Visitor Arrived',
