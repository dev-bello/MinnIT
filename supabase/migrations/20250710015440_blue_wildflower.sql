/*
  # SaaS and Subscription Management Schema

  1. New Tables
    - `subscriptions` - Subscription management for estates
    - `subscription_usage` - Usage tracking for subscription metrics
    - `estate_settings` - Configurable settings per estate
    - `audit_logs` - Audit trail for all estate activities

  2. Estate Table Updates
    - Add SaaS-related columns (subdomain, subscription_plan, etc.)
    - Add trial and subscription date tracking
    - Add feature flags and limits

  3. Security
    - Enable RLS on all new tables
    - Add policies for role-based access control
    - Create utility functions for access control

  4. Sample Data
    - Create sample estate with all related records
    - Add default settings for existing estates
*/
